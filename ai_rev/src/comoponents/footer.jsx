...
function Footer() {
  return (
    <footer className='bg-gradient-to-b from-dark to-gray-900 text-white pt-16 pb-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-12'>
          ...
          <div className='space-y-4'>
            ...
            <div className='flex space-x-4 pt-2'>
              <a href='#' className='text-gray-400 hover:text-white transition hover:-translate-y-1'>
          ...
          <div>
            ...
            <ul className="mt-6 space-y-3">
              {quickLinks.map((link, i)=>(
                <li key={i}>
                  <a href={link.href} className="text-gray-400 hover:text-primary transition flex items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-gray-400">Subscribe to our newsletter for the latest AI insights and company news.</p>
